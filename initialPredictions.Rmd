...
set.seed(seed)
yeojohnson.gbm <- train(totalstops~.,
                 data = training,
                 method = "gbm",
                 metric = metric,
                 preProc=c("YeoJohnson"),
...
yeojohnson.xgbLinear <- train(totalstops~.,
                 data = training,
                 method = "xgbLinear",
                 metric = metric,
                 preProc=c("YeoJohnson"),
...
yeojohnson.xgbTree <- train(totalstops~.,
                 data = training,
                 method = "xgbTree",
                 metric = metric,
                 preProc=c("YeoJohnson"),
...
# Results
boxcox.boosting.results <- resamples(list(GBM = yeojohnson.gbm,
                                          XGBLinear = yeojohnson.xgbLinear,
                                          XGBTree = yeojohnson.xgbTree,
                                          RF = yeojohnson.rf))
