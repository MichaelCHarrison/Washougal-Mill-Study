...
trans_validation <- preProcess(validation, method = c("center", "scale", "YeoJohnson"))


finalPredictions <- predict(finalModel, validation)
confusionMatrix(finalPredictions, validation$totalstops)
```
